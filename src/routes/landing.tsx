...
export const Route = createFileRoute("/landing")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Charm Flow AI (MAGNETO) — Carisma con IA",
      },
      {
...
/* ---------- Helper para extraer URL del asset JSON ---------- */
function getHeroVideoSrc(value: unknown) {
  if (typeof value === "string") return value;
  if (value && typeof value === "object") {
    const v = value as { url?: unknown; src?: unknown; default?: unknown };
...
const Bulb = ({ className = "h-5 w-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 21h6v-2H9v2zm3-19a7 7 0 0 0-4 12.7V17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-2.3A7 7 0 0 0 12 2z" />
  </svg>
);
...
function Landing() {
  ...
  const heroVideoSrc = getHeroVideoSrc(heroVideo);
      ...
      <section className="magneto-cinematic-bg relative h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <nav className="fixed top-4 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-16">
            ...
            <Link
              to="/login"
              className="md:hidden liquid-glass-strong rounded-full px-4 py-2 text-xs inline-flex items-center gap-1.5"
            >
          ...
          <div className="flex-1 flex flex-col items-center justify-center pt-24 px-4 text-center">
            ...
            >
              <strong className="font-semibold text-fuchsia-300">
                Charm Flow AI (MAGNETO)
              </strong>{" "}
              es el estudio definitivo de carisma con inteligencia artificial. Sube una
              captura, rescata chats enfriados, entrena roleplay interactivo y planifica
              citas con herramientas diseñadas exclusivamente para obtener resultados
              reales.
            </motion.p>
            ...
            >
              <div className="liquid-glass p-6 w-[240px] rounded-[1.5rem] text-left hover:scale-[1.02] transition-transform duration-300">
                ...
                <div className="mt-2 text-xs text-white/80 font-body font-light leading-relaxed">
                  De captura de pantalla a{" "}
                  <strong className="font-medium text-white">
                    5 aperturas de impacto
                  </strong>{" "}
                  listas para enviar.
                </div>
              </div>
              ...
              <div className="liquid-glass p-6 w-[240px] rounded-[1.5rem] text-left hover:scale-[1.02] transition-transform duration-300">
                ...
                <div className="mt-2 text-xs text-white/80 font-body font-light leading-relaxed">
                  Diferentes arquetipos de IA y{" "}
                  <strong className="font-medium text-white">personalidades</strong> para
                  dominar el simulador.
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="liquid-glass rounded-full px-5 py-2 text-xs md:text-sm text-white/85">
              Impulsado por <strong className="text-fuchsia-300">Charm Flow AI</strong>:
              la suite secreta del carisma moderno
            </div>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
              {["Aeon", "Vela", "Apex", "Orbit", "Zeno"].map((n) => (
                <span
                  key={n}
                  className="font-heading italic text-2xl md:text-3xl tracking-tight text-white/85"
                >
                  {n}
                </span>
              ))}
        ...
        <div className="relative z-10 px-6 md:px-16 lg:px-20 pt-16 pb-12 flex flex-col min-h-screen">
          <div className="mb-auto">
            <div className="text-sm font-body text-fuchsia-400 mb-4 tracking-[0.2em] uppercase">
              // El ecosistema de Charm Flow AI
            </div>
            ...
            {[
              {
                ...
                body:
                  "Sube la captura de cualquier perfil de chat y obtené de inmediato 5 abridores con tono ingenioso, calibrado y atrevido. Olvidate de quedarte en blanco.",
              },
              {
          ...
          <div className="mt-24 flex flex-col items-center text-center gap-6 relative">
            ...
            <h3 className="font-heading italic text-4xl md:text-5xl lg:text-6xl tracking-[-2px] leading-none max-w-2xl text-white z-10">
              Dejé de improvisar. Empezá a operar.
            </h3>
            <p className="text-slate-400 text-xs md:text-sm max-w-md font-body font-light z-10 leading-relaxed">
              Uníte a miles de hombres que utilizan el motor de{" "}
              <strong className="text-white">Charm Flow AI</strong> para transformar
              sus habilidades de conversación y citas.
            </p>
            <Link
              to="/login"
...
function Landing() {
  const navLinks = ["Escáner", "Simulador", "Citas", "Academia", "Comunidad"];
  // La importación directa del .mp4 ya devuelve la URL como string
  const heroVideoSrc = heroVideo as string;
