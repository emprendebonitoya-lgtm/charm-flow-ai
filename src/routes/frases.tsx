...
export const Route = createFileRoute("/frases")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Banco de frases con plataforma, escenario, rollo y contexto.",
      },
    ],
  }),
  component: Frases,
...
const FRASES: Frase[] = [
  {
    text: "Tu perfil está peligrosamente bien curado. ¿Estrategia o talento natural?",
    platform: "Instagram",
    escenario: "Opener",
    rollo: "Ingenioso",
    contexto: "Cuando ella tiene un feed muy estético",
  },
  {
    text: "Necesito tu opinión: ¿pizza con piña, crimen o malentendido cultural?",
    platform: "Tinder",
    escenario: "Opener",
    rollo: "Casual",
    contexto: "Para arrancar sin presión y forzar respuesta",
  },
  {
    text: "Vas a pensar que es un opener random, pero tengo una teoría sobre vos.",
    platform: "Bumble",
    escenario: "Opener",
    rollo: "Atrevido",
    contexto: "Genera curiosidad inmediata",
  },
  {
    text: "Cuidado, estás peligrosamente cerca de caerme bien.",
    platform: "WhatsApp",
    escenario: "Subir tensión",
    rollo: "Coqueto",
    contexto: "Cuando la conversa fluye y querés marcar interés",
  },
  {
    text: "Eso fue tan tu estilo que ya lo sentí venir tres mensajes antes.",
    platform: "Instagram",
    escenario: "Romper hielo",
    rollo: "Ingenioso",
    contexto: "Después de una respuesta característica",
  },
  {
    text: "No te pregunté cómo te fue con la mudanza, ¿sobrevivió la planta?",
    platform: "WhatsApp",
    escenario: "Rescate",
    rollo: "Tierno",
    contexto: "Reactivar un chat usando un detalle previo",
  },
  {
    text: "Esto ya pide café. ¿Jueves o viernes?",
    platform: "Tinder",
    escenario: "Cierre",
    rollo: "Casual",
    contexto: "Cerrar cita con opciones cerradas",
  },
  {
    text: "Te debo una historia mejor en persona. ¿Cuándo?",
    platform: "Bumble",
    escenario: "Cierre",
    rollo: "Coqueto",
    contexto: "Cuando ya hubo química en el chat",
  },
  {
    text: "Si te beso ahora arruino la conversación, así que mejor seguimos hablando.",
    platform: "WhatsApp",
    escenario: "Subir tensión",
    rollo: "Atrevido",
    contexto: "Solo después de buena química",
  },
  {
    text: "Te dejaste ver demasiado en esa última foto. Me caés bien.",
    platform: "Instagram",
    escenario: "Romper hielo",
    rollo: "Coqueto",
    contexto: "Para foto que muestra personalidad",
  },
  {
    text: "Spoiler: este mensaje probablemente cambie tu semana.",
    platform: "Tinder",
    escenario: "Opener",
    rollo: "Atrevido",
    contexto: "Frame alto desde el primer mensaje",
  },
  {
    text: "Recordame mañana mandarte algo que tengo que mostrarte.",
    platform: "WhatsApp",
    escenario: "Rescate",
    rollo: "Ingenioso",
    contexto: "Crea bucle abierto y excusa para volver",
  },
];
...
const PICON: Record<Frase["platform"], LucideIcon> = {
  Instagram,
  Tinder: Heart,
  Bumble: Heart,
...
const PCOLOR: Record<Frase["platform"], string> = {
  Instagram: "#E1306C",
  Tinder: "#FE3C72",
  Bumble: "#FFC629",
  WhatsApp: "#25D366",
  ...
  return (
    <AppShell title="Frases" subtitle="Filtrá por plataforma, escenario y rollo.">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        <button onClick={generate} className="btn-cyber px-5 py-3">
          Generar frase
        </button>
        <span className="text-[11px] text-muted-foreground">
          Usá los filtros y creá una frase que encaje con la situación.
        </span>
      </div>
      {generated && (
        <div className="neon-card rounded-2xl p-4 border border-[rgba(168,85,247,0.18)] mb-4">
          <div className="text-[11px] uppercase tracking-[0.28em] text-[#D8B4FE]/80 mb-2">
            Frase generada
          </div>
            ...
            return (
              <div key={i} className="neon-card rounded-2xl p-3.5">
                ...
                <div className="mt-2 flex items-center justify-between gap-2">
                  <p className="text-[11px] text-[#BFDBFE]/65 italic flex-1">
                    Contexto: {f.contexto}
                  </p>
                  <button
                    onClick={() => {
...
function Row<T extends string>({
  ...
  return (
    <div>
      <div className="text-[9.5px] tracking-[0.28em] uppercase text-muted-foreground mb-1.5">
        {label}
      </div>
      <div className="flex gap-1.5 overflow-x-auto pb-1 -mx-4 px-4 scrollbar-none">
        {items.map((it) => (
          <button
            key={it}
            onClick={() => onChange(it)}
            className={`chip whitespace-nowrap ${value === it ? "chip-active" : ""}`}
          >
            {it}
          </button>
        ))}
