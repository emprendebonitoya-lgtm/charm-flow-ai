...
const PILLS: Pill[] = [
  {
    ...
    g: ["#EC4899", "#8B5CF6"],
    details:
      "Entendé cómo la postura, las microexpresiones y el ritmo de tus gestos definen tu presencia. Mantené los hombros abiertos, usá el contacto visual con intención y evitá señales de inseguridad como tocarte la cara o cruzar brazos.",
  },
  {
    ...
    g: ["#D946EF", "#7C3AED"],
    details:
      "Elegí un lugar con buena energía y poca fricción. Dirigí la conversación con confianza, abrí espacio para que ella participe y cerrá con una propuesta concreta para el siguiente paso.",
  },
  {
    ...
    g: ["#EC4899", "#8B5CF6"],
    details:
      "Tu estado interno marca tu rendimiento. Definí tus límites, mantené una actitud de abundancia y responda al rechazo con calma. El frame fuerte hace que ella entre en tu mundo sin que vos te desgastes.",
  },
  {
    ...
    g: ["#A855F7", "#C084FC"],
    details:
      "Usá pocos mensajes para generar interés: un opener memorable, una reacción auténtica y una invitación ligera. Evitá textos largos, preguntas aburridas y el juego de '¿qué hacés?'.",
  },
  {
    ...
    g: ["#EC4899", "#D946EF"],
    details:
      "La voz es una herramienta de autoridad. Hablá con calma, evitá apurarte y usá pausas estratégicas. Un tono más bajo y controlado transmite seguridad sin sonar forzado.",
  },
  {
    t: "Abundancia Mental",
    ...
    g: ["#C084FC", "#A855F7"],
    details:
      "No dependas de un solo resultado: tenés opciones. Esta mentalidad te permite actuar desde el valor propio y no desde la urgencia. El rechazo se transforma en información, no en catástrofe.",
  },
  {
    ...
    g: ["#A855F7", "#EC4899"],
    details:
      "Incluí una foto de estilo, una de acción, una con amigos y una que muestre tu estética. Tu perfil debe ser claro, honesto y dar una sensación de misterio bien calibrada.",
  },
  {
    ...
    g: ["#9333EA", "#EC4899"],
    details:
      "No respondas instantáneamente a todo. Un poco de espacio crea curiosidad y demuestra que tu tiempo tiene valor. La pausa bien usada es un imán de interés.",
  },
  {
    ...
    g: ["#C084FC", "#EC4899"],
    details:
      "Usá insinuaciones sutiles y comentarios cargados de doble sentido sin caer en lo explícito. Hacé que ella complete la frase en su cabeza, y mantené siempre el respeto.",
  },
  {
    ...
    g: ["#D946EF", "#EC4899"],
    details:
      "El rechazo no es personal, es un señalador. Aprendé de cada experiencia, agradecé y seguí adelante sin que te arrastre. Eso es lo que hace a un hombre imparable.",
  },
  {
    ...
    g: ["#A855F7", "#C084FC"],
    details:
      "Imitá sutilmente su ritmo, postura y vocabulario para crear conexión. No copies de forma exacta: adaptá tu energía para que se sienta natural y cómodo.",
  },
  {
    ...
    g: ["#EC4899", "#C084FC"],
    details:
      "Arrancá con una apertura diferencial, seguí con una línea que genere interés y cerrá con una propuesta de cambio de canal. El número aparece cuando ya hay química y claridad.",
  },
];
...
const VIP_PILLS: Pill[] = [
  {
    ...
    g: ["#7C3AED", "#EC4899"],
    details:
      "Plantillas premium para abrir conversación, responder con atracción y llevar el chat hacia una cita sin sonar repetido.",
  },
  {
    ...
    g: ["#D946EF", "#8B5CF6"],
    details:
      "Estrategia para diseñar una primera salida con timing, ritmo y el cierre correcto que deja ganas de más.",
  },
];
  ...
  return (
    <AppShell>
      <div className="text-center mb-5">
        ...
        <h1 className="font-display text-[34px] font-bold mt-1 grad-cyber-text">
          Biblioteca Mental
        </h1>
        <p className="text-[13px] text-[#BFDBFE]/70 mt-1">
          Píldoras de conocimiento que cambian el juego.
        </p>
      </div>
      ...
      <div className="flex gap-2 overflow-x-auto pb-3 -mx-4 px-4 scrollbar-none">
        {CATS.map((c) => (
          <button
            key={c}
            onClick={() => setCat(c)}
            className={`chip whitespace-nowrap ${cat === c ? "chip-active" : ""}`}
          >
            {c}
          </button>
        ))}
      ...
      {recommendations.length > 0 && (
        <div className="neon-card rounded-3xl p-5 mb-4 border border-[rgba(168,85,247,0.16)]">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-4">
            ...
            <div className="text-[11px] text-[#BFDBFE]/65">
              Semana {Math.floor(dayOfYear / 7) + 1}
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-3">
            {recommendations.map((p, i) => (
              <div
                key={i}
                className="rounded-2xl bg-[rgba(255,255,255,0.05)] border border-white/10 p-4"
              >
                <div className="text-[11px] uppercase tracking-[0.25em] text-[#D8B4FE]/60 mb-2">
                  Recomendación {i + 1}
                </div>
      ...
      <div className="neon-card rounded-3xl p-5 mb-4 border border-[rgba(168,85,247,0.16)]">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          {VIP_PILLS.map((p, i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10 p-4 bg-[rgba(255,255,255,0.05)]"
            >
              <div className="flex items-center justify-between gap-3 mb-3">
                <div>
                  <div className="text-[12px] uppercase tracking-[0.24em] text-[#BFDBFE]/70">
                    {p.cat}
                  </div>
                  <div className="mt-2 font-semibold text-white">{p.t}</div>
                </div>
                <span className="rounded-full bg-white/5 px-2 py-1 text-[10px] uppercase tracking-[0.2em] text-[#E0E7FF]/75">
                  VIP
                </span>
              </div>
              <div className="text-[13px] leading-relaxed text-[#E0E7FF]/80">{p.s}</div>
              <div className="mt-4 text-[11px] text-[#93C5FD]/80">
                {p.min} min · {p.reads}
              </div>
              {!state.isPremium && (
                <div className="mt-4">
                  <Link to="/premium" className="btn-ghost w-full">
                    Ver plan premium
                  </Link>
                </div>
              )}
        ...
        <div className="neon-card rounded-3xl p-5 mb-4 border border-[rgba(168,85,247,0.16)]">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <div className="font-display text-[18px] font-semibold text-white">
                {FREE_LIMITS.bibliotecaPills} píldoras gratis. El resto es premium.
              </div>
            </div>
            <Link to="/premium" className="btn-cyber">
              Desbloquear todo
          ...
          <p className="mt-4 text-sm text-[#E0E7FF]/80">
            Probalas primero y luego elevá tu acceso para ver la biblioteca completa con
            explicaciones profundas y guías para cada categoría.
          </p>
        </div>
      )}
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(180deg, transparent 0%, rgba(4,6,15,0.42) 100%)",
                }}
              />
                  ...
                  <div className="flex-1 min-w-0 pr-14">
                    ...
                    <div className="flex items-center gap-3 mt-2 text-[10.5px] text-white/70">
                      <span className="flex items-center gap-1">
                        <Clock className="h-3 w-3" /> {p.min} min lectura
                      </span>
                      <span className="flex items-center gap-1">
                        <Users className="h-3 w-3" /> {p.reads} lecturas
                      </span>
                    </div>
                  </div>
                    ...
                    {locked ? (
                      <div className="space-y-3">
                        <div className="flex items-center gap-2 text-sm text-[#E0E7FF]/80">
                          ...
                          <span>
                            Contenido premium. Suscribite para ver la explicación completa.
                          </span>
                        </div>
